...
public class RaidActivities {
    ...
    /**
     * @return The raidIdentifier
     */
    public String getRaidIdentifier() {
        return raidIdentifier;
    }

    /**
     * @param raidIdentifier The raidIdentifier
     */
    public void setRaidIdentifier(String raidIdentifier) {
