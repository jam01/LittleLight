...
// */
//public class CharacterInventoryPresenter {
...
//    }
//
//    public void bindView(CharacterInventoryView view, String charId) {
//        this.view = view;
//        this.service = InventoryService.getInstance(((Fragment) view).getActivity().getApplicationContext());
//
//        view.showLoading(true);
//
//        subscription = service.getItemsByCharId(charId)
...
//                .subscribe(new CharacterInventorySubscriber());
//    }
//
...
//    }
//
//    public interface CharacterInventoryView {
...
//    }
//
//    private class CharacterInventorySubscriber extends Subscriber<List<InventoryItem>> {
//        @Override
